...
const Arrow: React.FC<PropsType & WrappedIconType> = ({ styles, direction }) => {
   let rotateDegree;
   switch (direction) {
      case 'top':
         rotateDegree = 180;
   ...
   return (
      <svg style={stylesWithRotation} className={s.arrow} width='11' height='6' viewBox='0 0 11 6' fill='#fff' xmlns='http://www.w3.org/2000/svg'>
